...
const SplashScreen = () => {
  ...
  return (
    ...
    >
      ...
      <div className="text-2xl mb-2 opacity-0 animate-[fade-in-three-fourth_1s_ease-in_6s_forwards]">
        A virus?
      </div>
      <div className="text-2xl flex gap-2 mb-4 lg:justify-center">
        ...
        <span className="opacity-0 animate-[fade-in-three-fourth_1s_ease-in_10s_forwards]">
          No.
        </span>
      </div>
      <div className="text-3xl mb-4 font-semibold opacity-0 animate-[fade-in-full_1s_ease-in_12s_forwards] ">
        An Idea.
      </div>
      <div className="flex gap-2 mb-2 text-xl lg:justify-center">
        ...
        <span className="opacity-0 animate-[fade-in-three-fourth_1s_ease-in_16s_forwards]">
          highly contagious.
        </span>
      </div>
