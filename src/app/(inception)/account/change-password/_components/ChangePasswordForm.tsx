...
const ChangePasswordForm = () => {
   ...
   return (
       <form action={handleAction} className="w-fit">
           ...
           <Input id="old_password" type="password" name="old_password" required className="mb-4" />
           <Label htmlFor="new_password">New Password</Label>
           <Input id="new_password" type="password" name="new_password" required className="mb-4" />
           <Label htmlFor="retype_password">Re-type Password</Label>
           <Input id="retype_password" type="password" name="retype_password" required className="mb-4" />
