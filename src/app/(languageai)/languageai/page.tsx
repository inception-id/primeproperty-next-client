...
const Languageai = () => {
  return <section className="w-full h-screen overflow-hidden p-4 flex flex-col items-center justify-center lg:max-w-lg mx-auto">
    ...
    <div className="grid grid-cols-2 gap-4 w-full">
     <Link href="/languageai/translate" className={cn(buttonVariants({}), "w-full")}>
      <LuLanguages />
       Translate
     </Link>
      <Link href="/languageai/checkbot" className={cn(buttonVariants({}), "w-full")}>
        <LuSquareTerminal/>
        Checkbot
      </Link>
      <Link href="/languageai/speech-to-text" className={cn(buttonVariants({}), "w-full")}>
        <LuAudioLines />
        Text to Speech
      </Link>
      <Link href="/languageai/text-to-speech" className={cn(buttonVariants({}), "w-full")}>
        <CgTranscript />
        Speech to Text
      </Link>
    </div>
