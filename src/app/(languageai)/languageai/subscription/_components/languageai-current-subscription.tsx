...
const LanguageaiCurrentSubscription = async ({stats, subscription, planName}: LanguageaiCurrentSubscriptionProps) => {
    return (
        <div className="max-w-lg">
            <div className="flex items-center justify-between">
                <div>
                    <div className="font-semibold text-xl capitalize">{planName} Plan</div>
                    <div className="opacity-50 text-sm">expired
                        at: {formatDateToIndonesian(subscription.created_at)}</div>
                </div>
                <Link className={cn(buttonVariants({variant: "outline", size: "sm"}), "hidden lg:flex")} href="/languageai/plans">See Pricing</Link>
            </div>
            <Table>
                <TableHeader>
                    <TableRow>
                ...
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell>{subscription.translation_limit || 'Unlimited'}</TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                        ...
                        <TableCell>{subscription.speech_to_text_limit || 'Unlimited'}</TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                        ...
                        <TableCell>{subscription.text_to_speech_limit || 'Unlimited'}</TableCell>
                    </TableRow>
                    <TableRow>
                ...
                <TableCaption>*History will show {subscription.history_limit} latest history</TableCaption>
            </Table>
        </div>
    )
};
