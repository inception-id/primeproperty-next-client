...
import TranscriptionHistoryDataTable
    from "@/app/(languageai)/languageai/history/speech-to-text/_components/transcription-history-data-table";

const TranscriptionHistoryTable = async () => {
    const transcriptionHistory = await findSpeechToTextHistory({ cache: "no-store" });
