...
const TranslateResult = () => {
    const {updatedCompletion, updateStore, translationId} = useTranslationStore(useShallow((state) => ({
                ...
                <div className="flex flex-col gap-1">
                    ...
                    {translationId &&
                        <Button
                            ...
                            onClick={async () => {
                                try {
                                    const translationStorage = await createTranslationStorage(translationId, updatedCompletion);
