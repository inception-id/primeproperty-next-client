...
const TranslateResult = () => {
    const {completion, isLoading} = useContext<UseCompletionHelpers>(TranslateContext);
    return (
        <div className="p-2 border h-[95vh] rounded-md">
            ...
            <div className="flex gap-2">
                ...
                <Button type="button" size="icon" variant="secondary" onClick={async ()=> await copyToClipboard(completion)}>
                    <LuCopy/>
                </Button>
            </div>
        </div>
