...
const TranscriptionStorageDeleteDialog = ({
  transcriptionId,
}: TTranscriptionStorageDeleteDialogProps) => {
  const router = useRouter();

  const onDeleteClick = async () => {
    try {
      const storage = await deleteTranscriptionStorage(transcriptionId);
      if (storage.data.id) {
...
export default TranscriptionStorageDeleteDialog;
