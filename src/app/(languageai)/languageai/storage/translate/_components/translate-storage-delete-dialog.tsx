...
const TranslateStorageDeleteDialog = ({translationId}: TTranslateStorageDeleteDialogProps) => {
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="max-w-sm">
                <DialogTitle className="font-semibold">Delete from storage?</DialogTitle>
                <DialogDescription className="text-sm mb-4">This action can&apos;t be undone</DialogDescription>
