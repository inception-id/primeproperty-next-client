...
const TranslateStorageUpdateForm = ({onCloseClick, row}: TranslateStorageUpdateFormProps) => {
    ...
    return (
        <form action={handleAction}>
            <div className="flex items-center justify-between mb-4">
              ...
              <Label htmlFor="title" className="opacity-75">Translation title</Label>
                <Input id="title" name="title" defaultValue={row.original.title || ""} placeholder="No title" className="mb-4" />
