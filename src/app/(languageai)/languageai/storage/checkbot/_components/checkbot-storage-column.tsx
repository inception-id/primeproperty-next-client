...
import CheckbotStorageOriginalTextColumn
  from "@/app/(languageai)/languageai/storage/checkbot/_components/checkbot-storage-original-text-column";
import CheckbotStorageResultlColumn
  from "@/app/(languageai)/languageai/storage/checkbot/_components/translate-storage-resullt-column";
