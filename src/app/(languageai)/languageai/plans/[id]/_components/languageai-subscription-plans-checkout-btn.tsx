...
import {
    createLanguageaiSubscriptionsCheckout
} from "@/lib/api/languageai-subscriptions/create-languageai-subscriptions-checkout";
import {convertSubscriptionPeriodToMonth, ESubscriptionPeriod} from "@/lib/enums/ESubscriptionPeriod";
...
const LanguageaiSubscriptionPlansCheckoutBtn = ({
    ...
    const handleClick = async () => {
        ...
        try {
            ...
            const checkout = await createLanguageaiSubscriptionsCheckout(checkoutPayload)
    ...
    return (
        <div className="flex items-center justify-between">
            <Link href="/languageai/plans" className={buttonVariants({variant: "outline"})}>
                Back
            </Link>

            <Button onClick={handleClick} disabled={isLoading} className={cn(isLoading && 'animate-bounce')}>
