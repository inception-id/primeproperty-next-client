...
const RemoveTranslateSharedStorageBtn = ({sharedStorageId ,refetchList}: RemoveTranslateSharedStorageBtnProps) => {
    const onDeleteClick = async () => {
        try {
            const deletedStorage = await deleteTranslationSharedStorage(sharedStorageId);
