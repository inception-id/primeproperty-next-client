...
import RemoveTranslateSharedStorageBtn
  from "@/app/(languageai)/languageai/shared/translate/_components/remove-shared-storage-btn";
    ...
    <div className="max-h-96 overflow-y-auto flex flex-col gap-1">
      {sharedTranslationStorage.map((sharedStorage) => (
        ...
        >
          ...
          <span>
            <RemoveTranslateSharedStorageBtn sharedStorageId={sharedStorage.id} refetchList={refetchList} />
          </span>
        </div>
      ))}
    </div>
