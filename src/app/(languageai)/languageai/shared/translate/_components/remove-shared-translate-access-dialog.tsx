...
const RemoveSharedTranslateStorageAccessDialog = ({
    ...
    const onDeleteClick = async () => {
        try {
            const translationStorage = await deleteTranslationSharedStorage(sharedTranslationStorageId);
        ...
        <Dialog>
            ...
            <DialogContent className="max-w-sm">
                <DialogTitle className="font-semibold">
                    Are you sure to remove &quot;{sharedTranslationStorageTitle || "No title"}&quot; translation from you shared storage?
                </DialogTitle>
