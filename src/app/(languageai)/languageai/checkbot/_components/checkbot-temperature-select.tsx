...
const CheckbotTemperatureSelect = () => {
  return (
    <>
      ...
      <Tooltip anchorSelect="#temperature" place="top">
        <div className="w-80">
          <p>Given a text and processed twice.</p>
          <p>Lower values will generate similar result.</p>
          <p>Higher values will generate variety of the result.</p>
        </div>
      </Tooltip>
    </>
  );
...
export default CheckbotTemperatureSelect;
