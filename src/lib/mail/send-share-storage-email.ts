...
export const sendShareStorageEmail= async (storageTitle: string, redirectPath: string, sendTo: string) => {
    ...
    try {
        ...
        return await mailTransporter.sendMail({
            ...
            html: createShareStorageEmailTemplate(decoded.email, storageTitle, redirectLink), // html body
        });
    } catch (e) {
        throw e;
    }
